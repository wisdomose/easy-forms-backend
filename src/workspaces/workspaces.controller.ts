...
export class WorkspacesController {
  ...
  async addMember(@Req() req: RequestWithAuth, @Param('id') workspaceId: string, @Body() body: { user_id: string; apply_defaults?: boolean }) {
    return { data: await this.service.addMember(req.auth!, workspaceId, body.user_id, body.apply_defaults ?? true) };
  }
